...
> **写入操作（create/update）** 使用 `字段编号`（如 `IBA001`）
...
| `IBA002` | 性质 | `nature` | string |  |
| `IBA003` | 日期 | `date` | string |  |
| `IBA004` | 客户 | `cust` | string |  |
| `IBA005` | 业务员 | `saleser` | string |  |
| `IBA006` | 部门 | `dept` | string |  |
| `IBA007` | 币种 | `currency` | string |  |
| `IBA008` | 汇率 | `exchange_rate` | float |  |
| `IBA009` | 专案 | `project` | string |  |
| `IBA010` | 送货邮编 | `delivery_postal_code` | string |  |
| `IBA011` | 送货地址 | `delivery_addr` | string |  |
| `IBA012` | 备注 | `remark` | string |  |
| `IBA013` | 复核编号 | `review_no` | string |  |
| `IBA014` | 复核姓名 | `review_name` | string |  |
| `IBA015` | 发票种类 | `invoice_type` | string |  |
| `IBA016` | 税率 | `tax_rate` | float |  |
| `IBA017` | 无税金额 | `amt_excluding_tax` | float |  |
| `IBA018` | 税额 | `tax_amt` | float |  |
| `IBA019` | 本币无税金额 | `amt_in_local_currency_excluding_tax` | float |  |
| `IBA020` | 本币税额 | `domestic_currency_tax_amt` | float |  |
| `IBA021` | 客户单号 | `customer_docNo` | string |  |
| `IBA022` | 审核码 | `approve_status` | string |  |
| `IBA023` | 预留字段 | `reserved_field1` | string |  |
| `IBA024` | 预留字段 | `reserved_field2` | string |  |
| `IBA025` | 订金 | `deposit` | float |  |
| `IBA026` | 订金已开票金额 | `deposit_invoiced_amt` | float |  |
| `IBA027` | 预留字段 | `reserved_field3` | string |  |
| `IBA028` | 预留字段 | `reserved_field4` | string |  |
| `IBA029` | 预留字段 | `reserved_field5` | string |  |
| `IBA030` | 预留字段 | `reserved_field6` | string |  |
| `IBA031` | 预留字段 | `reserved_field7` | string |  |
| `IBA032` | 预留字段 | `reserved_field8` | string |  |
| `IBA033` | 请款客户 | `request_payment_customer` | string |  |
| `IBA034` | 预留字段 | `reserved_field9` | string |  |
| `IBA035` | 预留字段 | `reserved_field10` | string |  |
| `IBA036` | 预留字段 | `reserved_field11` | string |  |
| `IBA037` | 运费 | `freight` | float |  |
| `IBA038` | 折让 | `allowance` | float |  |
| `IBA039` | 预留字段 | `reserved_field12` | string |  |
| `IBA040` | 预留字段 | `reserved_field13` | string |  |
| `IBA041` | 预留字段 | `reserved_field14` | string |  |
| `IBA042` | 预留字段 | `reserved_field15` | string |  |
| `IBA043` | 预留字段 | `reserved_field16` | float |  |
| `IBA044` | 预留字段 | `reserved_field17` | float |  |
...
| `IBA048` | 易隆单号 | `yilong_docNo` | string |  |
| `IBA049` | 易隆次单号 | `yilong_subDocNo` | string |  |
...
| `IBA063` | 打印次数 | `print_count1` | integer |  |
| `IBA064` | 打印人员 | `printer1` | string |  |
| `IBA065` | 打印时间 | `print_time1` | string |  |
...
| `IBA006` | `dept` | 部门 | |
| `IBA007` | `currency` | 币种 | |
| `IBA008` | `exchange_rate` | 汇率 | |
| `IBA009` | `project` | 专案 | |
| `IBA010` | `delivery_postal_code` | 送货邮编 | |
| `IBB001` | `docNo` | 单号 (单身) | |
| `IBB002` | `seq` | 序号 (单身) | |
| `IBB003` | `item_no` | 品号 (单身) | |
| `IBB004` | `product_name` | 品名 (单身) | |
| `IBB005` | `unit` | 单位 (单身) | |
...
- **写入（create/update）**：使用 `字段编号` 列（如 `IBA001`）
- **读取响应（getMultiple）**：同时返回 `字段编号` 和 `节点名称`
- **条件查询（fastquery）**：条件中的字段名使用 `节点名称`（别名）
- **审批/删除**：通过 `datakeys` 定位，使用主键 `IBA001`
