...
> **版本**: 3.1.0 | **平台**: Claude Code / Codex / OpenClaw / MCP 兼容平台
>
...
> v3.1: 增加 MCP 调用方式说明（stdio 协议）；支持 Codex 平台；frontmatter 版本管理。
...
> **调用方式**：yzcli-mcp 使用 **stdio** 传输协议（stdin/stdout JSON-RPC），**不是 HTTP 服务**。
    ...
    "cdsMaster": [
      {
        ...
        "IBA003": "20260528",
        "cdsDetail": [
          { "IBB003": "2000000110", "IBB005": "件", "IBB006": 20 }
        ]
      }
    ]
  }
